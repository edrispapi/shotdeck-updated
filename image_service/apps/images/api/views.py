...
class ImageViewSet(ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.action == 'list':
            # FIX 2: Changed '.only('id', ...)' to '.only('uuid', ...)' to match the model field name.
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            # FIX 3: Changed 'serializer.instance.id' to 'serializer.instance.uuid'
            send_event('image_created', {
                'image_id': serializer.instance.uuid,
